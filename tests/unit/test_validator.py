...
from src.datahub.core.registry import SchemaRegistry, TableSpec, ColumnSpec, validate_row, validate_scope
...
def _make_store():
    ...
    d = tempfile.mkdtemp()
    db_path = str(Path(d) / "test_validator.db")
...
# --- scope must exist for replace_scope ---
...
# --- validator empty snapshot for replace_scope with scope ---
...
# --- non-project-domain tables not regressed ---
