...
| dcp_plan_project_progress | 计划域 | prjCode, id | upsert | - | 项目进度 |
| dcp_plan_single_project_progress | 计划域 | prjCode, singleProjectCode, id | upsert | - | 单项工程进度 |
| dcp_plan_bidding_section_progress | 计划域 | prjCode, biddingSectionCode, id | upsert | - | 标段进度 |
| dcp_plan_dept_key_personnel | 计划域 | id | upsert | - | 关键人员 |
| dcp_tower | 项目域 | singleProjectCode, id | upsert | - | 杆塔 |
| dcp_substation | 项目域 | singleProjectCode | upsert | - | 变电站（空壳行已过滤） |
| dcp_line_branches | 项目域 | biddingSectionCode, id | upsert | - | 线路分支 |
| dcp_line_sections | 项目域 | biddingSectionCode, branchId, id | upsert | - | 架线区段 |
...
- 90 天回补验证通过：30628 行，0 失败，0 schema_mismatch，0 extra 依赖
