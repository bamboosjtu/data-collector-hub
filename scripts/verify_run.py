...
if len(sys.argv) > 1:
    ...
    # Check ingestion_messages for this job
    ...
    # Check table_writes for this job's messages
    print(f"\n=== Table Writes ===")
    try:
        writes = c.execute("""
    ...
    # Check for skipped rows (messages with error containing "skipped" or "empty_wrapper")
    print(f"\n=== Skipped Rows Check ===")
    try:
